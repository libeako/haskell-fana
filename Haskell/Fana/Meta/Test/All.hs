...
import qualified Fana.Meta.Test.Data.Tree.ParseFromElemList as TreeParse
import qualified Fana.Develop.Test.Define as Test
import qualified Fana.Serial.Bidir.Meta.Test.Main as Serial


all_tests :: Test
all_tests = Test.bunch "tests" [KeyIsString.all_tests, Serial.test, TreeParse.serialization_test]
